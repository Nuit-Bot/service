/*
Une partie de ce fichier (contenu des fonctions) se trouvent sur https://discordjs.guide
La partie fonctions exportées et support ESM sont faites par moi (TotoCode)
*/
